...
export default function BulkPrintPurchaseRequestsPage() {
  ...
  if (prs.length === 0) return <div style={{ padding: 32, textAlign: 'center' }}>No PRs selected</div>
    ...
    <>
      ...
      <div className="print:hidden" style={{ display: 'flex', gap: 12, alignItems: 'center', padding: '12px 16px', borderBottom: '1px solid #e5e7eb', background: '#fff' }}>
        ...
        <Button variant="outline" asChild>
          <Link href="/procurement/purchase-requests">← Back to PRs</Link>
        </Button>
      </div>
          ...
          return (
            ...
            >
              ...
              <div style={{ marginTop: 24, paddingTop: 10, borderTop: '1px solid #ddd', textAlign: 'center', fontSize: 10, color: '#999' }}>
                ...
                {prs.length > 1 && <span> · Page {prIndex + 1} of {prs.length}</span>}
              </div>
            </div>
          )
        })}
