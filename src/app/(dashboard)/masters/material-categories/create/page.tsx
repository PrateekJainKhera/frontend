...
export default function CreateMaterialCategoryPage() {
  ...
  // Form state (CategoryCode is auto-generated by backend)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true)
    try {
      await materialCategoryService.create({
        categoryName,
        quality,
        description,
        defaultUOM,
      ...
      const message = error instanceof Error ? error.message : 'Failed to create material category'
      toast.error(message)
    } finally {
      setSaving(false)
    }
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter the basic details for this material category. Category code will be auto-generated.
              </CardDescription>
            </CardHeader>
